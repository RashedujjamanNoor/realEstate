...
const PropertyListing = () => {
  ...
  return (
    <>
      <div className="mt-3 mx-[5%] lg:mx-[10%] overflow-x-hidden">
        ...
        <div className="mt-4 ">
          <div className="flex flex-col justify-center items-center lg:grid lg:grid-cols-3 lg:justify-center justify-items-center">
